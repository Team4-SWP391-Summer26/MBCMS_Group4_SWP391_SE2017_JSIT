                    ...
                    <div class="room-card">
                        <div class="room-top ${room.roomType == 'VIP' ? 't-vip' : (room.roomType == 'IMAX' ? 't-imax' : 't-standard')}">
                            <div>
                                ...
                                <div class="rt-type">${room.roomType} &middot; Cinema #${room.branchId}</div>
                            </div>
                        ...
                        <div class="room-body">
                            ...
                            <div class="text-muted small mt-2"><i class="bi bi-info-circle me-1"></i>Capacity is auto-calculated from the seat layout.</div>
                        </div>
                        <div class="room-foot">
                            ...
                            <form method="post" action="${pageContext.request.contextPath}/admin/halls" class="d-inline">
