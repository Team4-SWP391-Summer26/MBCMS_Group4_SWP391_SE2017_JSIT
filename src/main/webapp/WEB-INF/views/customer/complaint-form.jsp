                                        ...
                                        <%-- Flash messages --%>
                                            <c:if test="${param.success == '1'}">
                                                <div class="alert alert-success alert-dismissible fade show"
                                                    role="alert">
                                                    <i class="bi bi-check-circle me-2"></i><strong>Complaint
                                                        submitted!</strong>
                                                    Your complaint has been received. We will get back to you as soon as
                                                    possible.
                                            ...
                                            <%-- Submit Form --%>
                                                <div class="lc-elev p-4 mb-4">
                                                    <h5 class="fw-bold mb-1"><i
                                                            class="bi bi-exclamation-circle text-danger me-2"></i>Submit
                                                        a Complaint</h5>
                                                    <p class="text-muted small mb-4">You can only submit a complaint
                                                        about a showtime for which you have a confirmed booking.</p>

                                                    <form method="post"
                                                        action="${pageContext.request.contextPath}/customer/complaints"
                                                        novalidate>
                                                        <%@ include file="/WEB-INF/views/common/csrf-hidden.jspf" %>

                                                            <%-- Showtime selection --%>
                                                                <div class="mb-3">
                                                                    <label for="showtimeId"
                                                                        class="form-label fw-semibold">Select Showtime
                                                                        <span class="text-danger">*</span></label>
                                                                    <c:choose>
                                                                        <c:when test="${empty confirmedBookings}">
                                                                            <div class="alert alert-info mb-0">
                                                                                <i
                                                                                    class="bi bi-info-circle me-2"></i>You
                                                                                have no eligible bookings to submit a
                                                                                complaint for.
                                                                            </div>
                                                                        </c:when>
                                                                        <c:otherwise>
                                                                            <select name="showtimeId" id="showtimeId"
                                                                                ...
                                                                                <option value="">-- Select a Showtime --
                                                                                </option>
                                                                                <c:forEach var="bk"
