    ...
    <div class="col-12 col-md-3">
        <div class="lc-elev p-3 mb-3">
            ...
            <nav>
                ...
                <a href="${pageContext.request.contextPath}/customer/complaints"      class="lc-navitem active"><i class="bi bi-exclamation-circle"></i>Complaints</a>
                <a href="${pageContext.request.contextPath}/customer/support"         class="lc-navitem"><i class="bi bi-headset"></i>Support</a>
            </nav>
        </div>
    </div>
