    ...
    <%@ taglib prefix="c" uri="jakarta.tags.core" %>
        ...
        <head>
            ...
            <link href="${pageContext.request.contextPath}/assets/css/main.css?v=${applicationScope.assetVersion}"
                rel="stylesheet">
            <%-- Auth shell styles (.branding-card / .step-circle / .avatar-circle, focus ring) live in main.css /
                tokens.css --%>
        </head>
                                    ...
                                    <div class="d-flex align-items-center gap-2 text-nowrap">
                                        <c:choose>
                                            ...
                                            <c:when test="${currentStep == 'verify'}">
                                                <div class="step-circle text-white"
                                                    style="background-color: var(--primary);">2
                                                </div>
                                            </c:when>
                                            <c:otherwise>
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <div class="position-relative">
                                                    ...
                                                    <input type="text" name="code"
                                                        class="form-control text-center fw-bold" maxlength="6"
                                                        pattern="\d{6}"
