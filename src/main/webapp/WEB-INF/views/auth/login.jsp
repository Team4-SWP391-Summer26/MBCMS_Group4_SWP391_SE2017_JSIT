                    ...
                    <div class="col-lg-6 d-flex">
                        <div class="card p-4 p-md-5 border-0 shadow-sm w-100 d-flex flex-column justify-content-between"
                            ...
                            <div>
                                ...
                                <p class="text-center text-muted mb-4" style="font-size: 0.9rem;">Sign in to your PentaPlex
                                    account</p>
                                ...
                                <c:if test="${not empty successMsg}">
                                    <div class="alert alert-success py-2" style="font-size: 0.85rem;">${successMsg}
                                    </div>
                                </c:if>
                                <%-- Google OAuth error codes tra ve qua query param --%>
                                    ...
                                    <c:if test="${param.googleError == 'server_error'}">
                                        <div class="alert alert-danger py-2" style="font-size: 0.85rem;">
                                            Google sign-in is temporarily unavailable. Please try again or use your
                                            email and password.
                                        </div>
                                    </c:if>
                                    ...
                                    <c:if test="${param.verified == 'true'}">
                                        <div class="alert alert-success py-2" style="font-size: 0.85rem;">Account
                                            verified successfully! Please sign in.</div>
                                    </c:if>
                                        ...
                                        <%@ include file="/WEB-INF/views/common/csrf-hidden.jspf" %>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="position-relative">
                                                    ...
                                                    <span class="position-absolute"
                                                        style="right: 12px; top: 50%; transform: translateY(-50%); color: #9ca3af; cursor: pointer;"
                                    ...
                                    <div class="d-flex align-items-center my-3">
                                        ...
                                        <span class="mx-3 text-secondary" style="font-size: 0.75rem;">or continue
                                            with</span>
                                        <hr class="flex-grow-1" style="border-color: #e5e7eb;">
                                    </div>
                                    ...
                                    <a href="${pageContext.request.contextPath}/auth/google/login"
                                        class="btn w-100 border d-flex align-items-center justify-content-center gap-2 mb-4"
                                        style="background: #ffffff; border-color: #d1d5db; height: 44px; border-radius: 8px; font-weight: 500; font-size: 0.9rem; color: #4b5563; text-decoration: none;">
                                        <svg width="18" height="18" viewBox="0 0 24 24">
                                            ...
                                            <path fill="#FBBC05"
                                                d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.06H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.94l2.85-2.22c-.62-.62-1.01-1.38-1.18-2.21z" />
                                            <path fill="#EA4335"
                            ...
                            <div class="text-center mt-2" style="font-size: 0.9rem;">
                                ...
                                <a href="${pageContext.request.contextPath}/auth/register"
                                    class="fw-semibold text-decoration-none" style="color: var(--primary);">Register
                                    now</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="branding-card w-100">
                            ...
                            <div style="position: relative; z-index: 1;">
                                ...
                                <div class="d-inline-flex align-items-center mb-4"
                                    ...
                                    <i class="bi bi-film" style="color: var(--gold); margin-right: 8px;"></i> WELCOME
                                    <span style="margin-left: 8px; opacity: 0.5;">──</span>
                                </div>

                                <!-- Title & Subtitle -->
                                <h1 class="fw-bold text-white mb-3"
                                    style="font-size: 2.6rem; line-height: 1.2; letter-spacing: -0.02em; font-family: 'Segoe UI', sans-serif;">
                                    Your Cinema,<br>Your Experience.
                                </h1>
                                <p class="text-white-50"
                                    style="font-size: 0.95rem; line-height: 1.6; max-width: 380px;">
                                    Book tickets across all PentaPlex locations, choose your seats, and earn points on every
                                    booking.
                                </p>
                            </div>
                            ...
                            <div class="d-flex align-items-center gap-3" style="position: relative; z-index: 1;">
                                <div class="d-flex">
                                    ...
                                    <span class="avatar-circle"
                                        style="background: #10b981; z-index: 3; margin-left: -10px;">TL</span>
                                    <span class="avatar-circle"
                                        style="background: #f97316; z-index: 2; margin-left: -10px;">LN</span>
                                    <span class="avatar-circle"
                                        style="background: #eab308; z-index: 1; margin-left: -10px;">PH</span>
                                </div>
                                <div style="font-size: 0.9rem; color: rgba(255,255,255,0.7); line-height: 1.4;">
                                    <strong class="text-white fw-semibold" style="font-size: 0.95rem;">3,400+
                                        customers</strong><br>
                                    <span style="font-size: 0.85rem; color: rgba(255, 255, 255, 0.5);">across HCMC &
                                        Hanoi</span>
                                </div>
                            </div>
                        </div>
