                    ...
                    <div class="col-lg-6 d-flex">
                        <div class="card p-4 p-md-5 border-0 shadow-sm w-100 d-flex flex-column justify-content-between"
                            ...
                            <div>
                                ...
                                <p class="text-center text-muted mb-4" style="font-size: 0.9rem;">Sign in to your MBCMS
                                    account</p>
                                ...
                                <c:if test="${not empty sessionScope.successMsg}">
                                    <div class="alert alert-success py-2" style="font-size: 0.85rem;">${sessionScope.successMsg}</div>
                                ...
                                <form method="post" action="${pageContext.request.contextPath}/auth/login">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-4"
                                        ...
                                        <a href="${pageContext.request.contextPath}/auth/forgot-password"
                                            class="text-decoration-none fw-semibold" style="color: #2563eb;">Forgot
                                            Password?</a>
                                    </div>
                            ...
                            <div class="text-center mt-2" style="font-size: 0.9rem;">
                                ...
                                <a href="${pageContext.request.contextPath}/auth/register"
                                    class="fw-semibold text-decoration-none" style="color: #2563eb;">Register now</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="branding-card w-100">
                            ...
                            <div style="position: relative; z-index: 1;">
                                ...
                                <div class="d-inline-flex align-items-center mb-4"
                                    ...
                                    <span style="color: #fbbf24; margin-right: 8px;">✨</span> WELCOME <span
                                        style="margin-left: 8px; opacity: 0.5;">──</span>
                                </div>
                                ...
                                <p class="text-white-50"
                                    ...
                                    Book tickets across all MBCMS locations, choose your seats, and earn points on every
                                    booking.
                                </p>
                            </div>
