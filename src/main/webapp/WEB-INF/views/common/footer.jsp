            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="d-flex align-items-center mb-3">
                        <!-- Logo SVG -->
                        <img src="${pageContext.request.contextPath}/assets/img/logo.png" alt="PentaPlex Logo" height="48" style="filter: brightness(0) invert(1); object-fit: contain;" />
                    </div>
                    <p class="mb-4 text-secondary" style="line-height: 1.6; max-width: 320px;">
                        Vietnam's multi-branch cinema booking platform. Pick your seat, grab some popcorn, and earn
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="contact-item">
                        ...
                        <div class="contact-info">
                            ...
                            <div class="text-secondary">Hoa Lac Hi-Tech Park, Km29 Thang Long Blvd, Thach That, Hanoi
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="contact-item">
                        ...
                        <div class="contact-info">
                            ...
                            <div><a href="mailto:group4mbcms@gmail.com"
                                    class="text-secondary hover-white">group4mbcms@gmail.com</a></div>
                        </div>
                    </div>
                </div>
            </div>
