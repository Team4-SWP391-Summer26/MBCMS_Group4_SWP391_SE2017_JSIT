            ...
            <nav class="navbar navbar-expand-lg navbar-custom">
                <div class="container">
                    ...
                    <a class="navbar-brand d-flex align-items-center" href="${pageContext.request.contextPath}/home">
                        <img src="${pageContext.request.contextPath}/assets/img/logo.png" alt="PentaPlex Logo" height="52" style="object-fit: contain;" />
                    </a>
                    ...
                    <div class="collapse navbar-collapse" id="navMenu">
                        <ul class="navbar-nav ms-lg-5 me-auto mb-2 mb-lg-0 mt-2 mt-lg-0 gap-4">
                            ...
                            <li class="nav-item">
                                <a class="nav-link <c:if test=" ${activeMenu=='cinemas' }">active</c:if>"
                                    href="#">Cinemas</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link <c:if test=" ${activeMenu=='promotions' }">active</c:if>"
                                    href="#">Promotions</a>
                            </li>
                        </ul>
                        ...
                        <div class="d-flex align-items-center flex-column flex-lg-row gap-3 mt-2 mt-lg-0">
                            ...
                            <!-- Search -->
                            <form class="search-container w-100" action="${pageContext.request.contextPath}/movies"
                                method="GET" style="max-width: 250px; margin-bottom: 0;">
                                ...
                                <input type="text" class="search-input" placeholder="Search movies..." name="q"
                                    maxlength="100" value="<c:out value='${param.q}' />" />
                            </form>
                                ...
                                <%-- ── Notification Bell: chỉ dành cho CUSTOMER ── --%>
                                    <c:if test="${not empty sessionScope.currentUser and role == 'CUSTOMER'}">
                                        <div class="notif-wrap" style="position:relative;">
                                            <%-- Bell trigger button --%>
                                                <button class="notification-btn" id="notifBell" type="button"
                                   ...
                                   d-flex align-items-center gap-2" href="#" data-bs-toggle="dropdown"
                                           ...
                                           display:flex;align-items:center;gap:.5rem;">
                                                        ...
                                                        <li>
                                                            <form method="post"
                                                                ...
                                                                class="d-inline m-0">
                                                                <%@ include
                                                                    file="/WEB-INF/views/common/csrf-hidden.jspf" %>
                                                                    <button type="submit"
                                                ...
                                                <c:when test="${not empty sessionScope.currentUser}">
                                                    <c:choose>
                                                        <c:when test="${role == 'ADMIN'}">
                                                            <c:set var="dashUrl" value="/admin/dashboard" />
                                                        </c:when>
                                                        <c:when test="${role == 'BRANCH_STAFF'}">
                                                            <c:set var="dashUrl" value="/staff/booking" />
                                                        </c:when>
                                                        <c:otherwise>
                                                            <c:set var="dashUrl" value="/branch/dashboard" />
                                                        </c:otherwise>
                                                    </c:choose>
                                                    <div class="dropdown">
                                                        <a class="dropdown-toggle fw-semibold text-decoration-none d-flex align-items-center gap-2"
                                                            ...
                                                            <i class="bi bi-person-circle"
                                                                style="color:#4b5563; font-size:1.15rem;"></i>
                                                            ${sessionScope.currentUser.fullName}
                                                        </a>
                                                        <ul class="dropdown-menu dropdown-menu-end border-0 shadow-sm"
                                                            style="border:1px solid #e5e7eb !important;border-radius:8px;">
                                                            ...
                                                            <li>
                                                                <form method="post"
                                                                    ...
                                                                    <%@ include
                                                                        file="/WEB-INF/views/common/csrf-hidden.jspf" %>
                                                                        <button type="submit"
                                                                            class="dropdown-item py-2 px-3 text-danger border-0 bg-transparent w-100 text-start d-flex align-items-center gap-2"
