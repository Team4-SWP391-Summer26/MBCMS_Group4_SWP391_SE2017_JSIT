    ...
    <body class="bg-light">
        ...
        <div class="container py-5 d-flex align-items-center justify-content-center lc-error-shell">
            <div class="card p-5 border-0 shadow-sm text-center lc-error-card">
                <div class="mb-4 d-inline-flex align-items-center justify-content-center rounded-circle lc-error-icon lc-error-icon-warning">
                    <i class="bi bi-shield-exclamation"></i>
                </div>

                <h1 class="fw-bold mb-2 lc-error-code">404</h1>
                <h4 class="fw-bold mb-3 lc-error-title">Page not found</h4>
