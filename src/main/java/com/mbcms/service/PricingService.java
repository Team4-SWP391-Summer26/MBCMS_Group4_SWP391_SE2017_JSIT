...
/**
 * PricingService - tinh gia ve theo loai ghe (UC39 Set price).
 * Owner: HungNT.
 *
 * Quy tac (chot 13/06/2026, SDS bang seats: "Affects price multiplier"):
 *   final price = showtimes.base_price x multiplier theo seats.seat_type
 *   STANDARD x1.0 ; VIP x1.2
 */
public interface PricingService {
     ...
     *
     * @throws IllegalArgumentException neu basePrice null/<=0 hoac seatType khong hop le
     */
     ...
     *
     * @throws IllegalArgumentException neu list rong hoac co ghe seatType khong hop le
     */
