...
public class BookingServiceImpl implements BookingService {
    ...
    public Booking createPendingBooking(String customerUsername, long showtimeId,
        ...
        if (st == null) throw new IllegalArgumentException("Suất chiếu không tồn tại.");
        ...
        for (Seat s : allSeats) seatMap.put(s.getSeatId(), s);
    ...
    public Booking confirmBooking(long bookingId, String customerUsername) {
        ...
        if (updated == 0) {
            ...
            if (b == null) throw new IllegalArgumentException("Booking không tồn tại.");
        ...
        if (confirmed != null && confirmed.getPromoId() != null) {
            try { promoDao.incrementUsedCount(confirmed.getPromoId()); }
            catch (Exception e) {
